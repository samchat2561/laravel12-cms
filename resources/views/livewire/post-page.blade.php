<div class="max-w-screen-xl mx-auto my-2 bg-white shadow-2xl rounded-2xl mb-12">
    <!-- Breadcrumb -->
    ...
    <article class="bg-white">
        <div class="container mx-auto px-4 py-12">
            <div class="max-w-6xl mx-auto">
                ...
                <!-- Author Info -->
                <div class="flex items-center space-x-4 mb-8 pb-8 border-b border-b-gray-300">
                ...
                <!-- Share Buttons -->
                <div class="mt-8 pt-8 border-t border-t-gray-300">
                    ...
                    <div class="flex items-start space-x-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700 mb-4">
                                ...
                                applications. He's passionate about emerging technologies and loves sharing his
                                knowledge
    ...
    <section class="bg-white py-16">
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <!-- Comment 1 -->
                <div class="mb-8 pb-8 border-b border-b-gray-300">
